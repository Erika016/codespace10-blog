 ...
 */
final class Version20220606152358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comentario (id INT AUTO_INCREMENT NOT NULL, entrada_id INT NOT NULL, usuario_id INT NOT NULL, fecha DATE NOT NULL, texto LONGTEXT NOT NULL, estado SMALLINT NOT NULL, INDEX IDX_4B91E702A688222A (entrada_id), INDEX IDX_4B91E702DB38439E (usuario_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
